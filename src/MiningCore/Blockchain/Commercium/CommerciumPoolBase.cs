...
{
    public class CommerciumPoolBase : PoolBase
    {
        public CommerciumPoolBase(IComponentContext ctx,
        ...
        protected CommerciumJobManager manager;
        ...
        protected CommerciumJobManager CreateJobManager()
        {
            return ctx.Resolve<CommerciumJobManager>(
