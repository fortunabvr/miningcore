...
{
    public class CommerciumJob
    {
        protected CommerciumChainConfig chainConfig;
        ...
        public CommerciumBlockHeader BlockHeader { get; protected set; }
        public CommerciumGetWork Work { get; protected set; }
